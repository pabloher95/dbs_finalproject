            ...
            <Card key={product.id} className="p-6">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="mt-2 font-display italic text-3xl leading-tight">{product.name}</p>
              ...
              <div className="mt-5 overflow-hidden rounded-2xl border border-[var(--line)] bg-[var(--paper-bright)]">
